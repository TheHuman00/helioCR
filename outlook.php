...
<section class="py-5">
    <div class="container px-5 my-5">
        <div class="text-center mb-5">
            <h1 class="fw-bolder">Outlook Calendrier</h1>
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <ol>
                                    <li>Rendez vous sur ce lien : <a href="https://outlook.office.com/calendar/addcalendar" target="_blank">https://outlook.office.com/calendar/addcalendar</a></li>
                                    <li>Cliquez sur <strong>S'abonner à partir du web</strong></li>
