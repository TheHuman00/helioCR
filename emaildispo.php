...
$urlredirect = "https://croix-rouge-ixelles.com/eventadmin?nom=$eventt";
...
foreach ($disponibilites as $disponibilite) {
	if ($disponibilite['dispo'] == "1") {
		if ($disponibilite['event'] == $eventt) {
			$values[] = "<b style=\"color: #333333;\"> - " . $disponibilite['user'] . "<b> <br>";
		}
	}
}
$userdispo = implode("\n", $values);
...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			padding-top: 20px;
			padding-bottom: 20px;">
			<a target="_blank" style="text-decoration: none;"><img border="0" vspace="0" hspace="0"
...
$body2 = str_replace('$userdispo', $userdispo, $body);
$body3 = str_replace('$titre', $titre, $body2);
$body4 = str_replace('$date', $date, $body3);
$body5 = str_replace('$urlredirect', $urlredirect, $body4);
...
try {
	...
	$mail->addAddress('michael.deville@firebru.brussels', 'Deville Michael');

	$mail->isHTML(true);
	$mail->Subject = "Assez de personnel - $titre du $date";
	$mail->Body    =  $body5;
	$mail->AltBody = '...';

	$mail->send();
	$session->msg("s", "Information transmise");
	redirect("eventuser?nom=$eventt");
} catch (Exception $e) {
