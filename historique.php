    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: 'loadhisto.php',
                eventColor: '#db3434',
                eventClick: function(info) {
                    titleeventdate = info.event.title;
                    titreevent = titleeventdate.split(" | ");
                    troisdateevent = titreevent[3];
                    deuxdateevent = troisdateevent.split("-");
                    dateevent = deuxdateevent[2] + "-" + deuxdateevent[1] + "-" + deuxdateevent[0];
                    window.location = "eventadmin?nom=" + titreevent[2] + "DATE" + dateevent;
                }
            });
            calendar.render();
        ...
        <section class="py-3">
            <div class="container">
                <div class="text-center mb-5">
                    <h1 class="fw-bolder">Historique</h1>
                    <p class="lead fw-normal text-muted mb-0">Par semaine</p>
                    <div id='calendar'></div>
                </div>
                <div id='calendar'></div>
                <div class="row gx-5">
